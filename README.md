...
5. Implementare controlli: Attuare misure tecniche e non per mitigare i rischi (es. firewall, SIEM (Security Information and Event Management), training del personale; **snort** è un **IPS** intrusion prevention system, open-source/a codice aperto; **IDS** intrusion detection system).
